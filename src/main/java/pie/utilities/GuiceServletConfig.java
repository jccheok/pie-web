...
import pie.servlets.GetAllHomeworkServlet;
...
import pie.servlets.SendDraftHomeworkServlet;
...
import pie.servlets.ViewHomeworkDetailsServlet;
	...
	protected Injector getInjector() {
		return Guice.createInjector(new ServletModule() {
			...
			protected void configureServlets() {
				...
				serve("*/servlets/secured/staff/group/sendhomework").with(SendHomeworkServlet.class);
				...
				serve("*/servlets/secured/staff/group/senddrafthomework").with(SendDraftHomeworkServlet.class);
